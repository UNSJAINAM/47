...
function preload(){
  ...
  jungleImage = loadImage("assets/bg2.jpg");
  shrub1 = loadImage("assets/flow1.png");
  shrub2 = loadImage("assets/flow2.png");
  shrub3 = loadImage("assets/flow3.png");
  obstacle1 = loadImage("assets/fire1.png");
